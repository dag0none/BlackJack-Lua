...
function Bet:enter()
    buttonsBET = {
        createButton(56, 55, assets.plus, function() if coins > 0 then bet = bet + 1 coins = coins - 1 sound.coin:stop() sound.coin:play() end end),
        createButton(64, 55, assets.minus, function() if bet > 0 then bet = bet - 1 coins = coins + 1 sound.coin:stop() sound.coin:play() end end),
